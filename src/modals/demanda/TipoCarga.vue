<template>
  <div class="w-full">
    ...
    <AddTipoCarga v-model="openAddModal" @created="addNovoTipo" />
  </div>
</template>
...
import AddTipoCarga from '@/modals/demanda/AddTipoCarga.vue'
...
export default defineComponent({
  ...
  methods: {
    ...
    async loadFakeData() {
      ...
      this.items = [
        { id: 1, descricao: 'Paletizada' },
        { id: 2, descricao: 'Batida' },
        { id: 3, descricao: 'Mista' },
      ]
